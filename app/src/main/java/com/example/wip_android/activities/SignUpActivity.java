...
public class SignUpActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> departmentAdapter = new ArrayAdapter<String>(this, R.layout.department_dropdown_item,
                departments);
    ...
    private void checkUser() {
        this.userViewModel.checkUser(this.edtEmail.getEditText().getText().toString(),
                this.edtEmployeeID.getEditText().getText().toString());
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(getApplicationContext(), "Authentication successful!", Toast.LENGTH_LONG)
                                    .show();
    ...
    private Boolean validateData() {
        ...
        if (!edtPassword.getEditText().getText().toString()
                .equals(this.edtConfirmPassword.getEditText().getText().toString())) {
